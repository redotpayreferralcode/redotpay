...
| 9 | Technical on-page | URL, canonical, speed, mobile, schema, llms.txt / llms-full.txt |
...
URL/slug, canonical, mobile, page speed, HTTPS, schema markup, llms.txt / llms-full.txt presence, score.
