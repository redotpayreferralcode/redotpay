...
| Page-level technical | 10% | 10 | Clean URL; correct canonical; mobile-friendly; mobile LCP <=2.5s; HTTPS valid; appropriate schema; agent-readable files (llms.txt / llms-full.txt) at the root. |
...
| Missing llms.txt / llms-full.txt | Low | Create llms.txt and llms-full.txt at root to assist AI engines and crawlers |
